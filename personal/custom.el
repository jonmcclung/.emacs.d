(custom-set-variables
 ...
 '(message-suppression-these
   (quote
    ("Error during redisplay: (jit-lock-function 1) signaled (void-variable gas-hi-global-undef)" "Error running timer `gas-symbol-highlight-maybe': (void-variable gas-changed)")))
